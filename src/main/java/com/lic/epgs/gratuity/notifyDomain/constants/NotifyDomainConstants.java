package com.lic.epgs.gratuity.notifyDomain.constants;


public class NotifyDomainConstants {
	...
	public static final Integer SUCCESS_MSG = 1;
	public static final Integer FAIL_MSG = 0;
