...
@Entity
@Builder
@Table(name = "PMST_MEMBER_ADDRESS")
public class PolicyMemberAddressEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_MBR_ADDR_ID_SEQ")
	@SequenceGenerator(name = "PMST_MBR_ADDR_ID_SEQ", sequenceName = "PMST_MBR_ADDR_ID_SEQ", allocationSize = 1)
