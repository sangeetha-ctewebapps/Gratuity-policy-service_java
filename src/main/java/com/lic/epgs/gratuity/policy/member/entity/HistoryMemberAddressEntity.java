...
@Entity
@Builder
@Table(name = "PMST_HIS_MEMBER_ADDRESS")
public class HistoryMemberAddressEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_MBR_ADDR_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_MBR_ADDR_ID_SEQ", sequenceName = "PMST_HIS_MBR_ADDR_ID_SEQ", allocationSize = 1)
	...
	@Column(name ="PMST_MEMBER_ADDRESS_ID") private Long pmstMemAddressId;
