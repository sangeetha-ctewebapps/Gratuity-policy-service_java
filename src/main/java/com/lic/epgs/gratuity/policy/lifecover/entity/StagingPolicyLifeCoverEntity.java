...
@Setter
@Entity
@Table(name = "PSTG_LIFE_COVER")
public class StagingPolicyLifeCoverEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PSTG_LF_CV_ID_SEQ")
	@SequenceGenerator(name = "PSTG_LF_CV_ID_SEQ", sequenceName = "PSTG_LF_CV_ID_SEQ", allocationSize = 1)
