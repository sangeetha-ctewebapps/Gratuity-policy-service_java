...
@Entity
@Builder
@Table(name = "PMST_HIS_MEMBER_BANK_ACCOUNT")
public class HistoryMemberBankAccountEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_MBR_BNK_ACC_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_MBR_BNK_ACC_ID_SEQ", sequenceName = "PMST_HIS_MBR_BNK_ACC_ID_SEQ", allocationSize = 1)
	...
	@Column(name="PMST_MEMBER_BANK_ACCOUNT_ID") private Long pmstMemBankAccountId;
