...
@AllArgsConstructor
@Entity
@Table(name = "PMST_CONTRIBUTION")
public class MasterPolicyContributionEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_CONTRIBUTION_ID_SEQ")
	@SequenceGenerator(name = "PMST_CONTRIBUTION_ID_SEQ", sequenceName = "PMST_CONTRIBUTION_ID_SEQ", allocationSize = 1)
