...
@Setter
@Entity
@Table(name = "PMST_HIS_POLICY")
public class PolicyHistoryEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_POLICY_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_POLICY_ID_SEQ", sequenceName = "PMST_HIS_POLICY_ID_SEQ", allocationSize = 1)
...
//	private String rejectedRemarks;
	...
	private Long isApprovalEscalatedToCO;
	...
	private Long isMinPaymentReceived;
	...
	private Long memberUniIdendifierId;
