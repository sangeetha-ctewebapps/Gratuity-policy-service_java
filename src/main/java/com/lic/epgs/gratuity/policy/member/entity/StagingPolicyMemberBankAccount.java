...
@Entity
@Builder
@Table(name = "PSTG_MEMBER_BANK_ACCOUNT")
public class StagingPolicyMemberBankAccount {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PSTG_MBR_BNK_ACC_ID_SEQ")
	@SequenceGenerator(name = "PSTG_MBR_BNK_ACC_ID_SEQ", sequenceName = "PSTG_MBR_BNK_ACC_ID_SEQ", allocationSize = 1)
