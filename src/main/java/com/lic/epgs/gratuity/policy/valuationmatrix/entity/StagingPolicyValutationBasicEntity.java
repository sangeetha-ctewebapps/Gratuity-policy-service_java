...
@Setter
@Entity
@Table(name = "PSTG_VALUATIONBASIC")
public class StagingPolicyValutationBasicEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PSTG_VALUATIONBASIC_ID_SEQ")
	@SequenceGenerator(name = "PSTG_VALUATIONBASIC_ID_SEQ", sequenceName = "PSTG_VALUATIONBASIC_ID_SEQ", allocationSize = 1)
