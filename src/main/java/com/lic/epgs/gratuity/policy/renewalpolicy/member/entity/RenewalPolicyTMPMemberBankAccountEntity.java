...
@Entity
@Builder
@Table(name = "PMST_TMP_MEMBER_BANK_ACCOUNT")
public class RenewalPolicyTMPMemberBankAccountEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_TMP_MBR_BNK_ACC_ID_SEQ")
	@SequenceGenerator(name = "PMST_TMP_MBR_BNK_ACC_ID_SEQ", sequenceName = "PMST_TMP_MBR_BNK_ACC_ID_SEQ", allocationSize = 1)
	...
	@Column(name = "PMST_MEMBER_BANK_ACCOUNT_ID")	private Long pmstMemberBankAccId;
	@Column(name = "RECORD_TYPE")	private String recordType;
	@Column(name = "PMST_HIS_MEMBANK_ACCOUNT_ID") private Long pmstHisMemBankAccoutId;
