...
@Setter
@Entity
@Table(name = "PSTG_SCHEMERULE")
public class StagingPolicySchemeRule {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PSTG_SCHRULE_ID_SEQ")
	@SequenceGenerator(name = "PSTG_SCHRULE_ID_SEQ", sequenceName = "PSTG_SCHRULE_ID_SEQ", allocationSize = 1)
