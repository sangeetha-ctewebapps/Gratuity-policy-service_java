...
@Setter
@Entity
@Table(name = "PMST_HIS_SCHEMERULE")
public class PolicySchemeRuleHistoryEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_SCHRULE_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_SCHRULE_ID_SEQ", sequenceName = "PMST_HIS_SCHRULE_ID_SEQ", allocationSize = 1)
