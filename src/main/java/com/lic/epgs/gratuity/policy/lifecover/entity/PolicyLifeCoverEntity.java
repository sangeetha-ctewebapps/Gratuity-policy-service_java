...
@Setter
@Entity
@Table(name = "PMST_LIFE_COVER")
public class PolicyLifeCoverEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_LF_CV_ID_SEQ")
	@SequenceGenerator(name = "PMST_LF_CV_ID_SEQ", sequenceName = "PMST_LF_CV_ID_SEQ", allocationSize = 1)
