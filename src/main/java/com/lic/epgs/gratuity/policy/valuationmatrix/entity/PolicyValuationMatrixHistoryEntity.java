...
@Setter
@Entity
@Table(name = "PMST_HIS_VALUATIONMATRIX")
public class PolicyValuationMatrixHistoryEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_VAL_MATRX_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_VAL_MATRX_ID_SEQ", sequenceName = "PMST_HIS_VAL_MATRX_ID_SEQ", allocationSize = 1)
