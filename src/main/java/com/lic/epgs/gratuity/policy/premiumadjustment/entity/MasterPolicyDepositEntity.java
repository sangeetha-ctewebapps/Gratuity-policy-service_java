...
@AllArgsConstructor
@Entity
@Table(name = "PMST_DEPOSIT")
public class MasterPolicyDepositEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_DEPOSIT_ID_SEQ")
	@SequenceGenerator(name = "PMST_DEPOSIT_ID_SEQ", sequenceName = "PMST_DEPOSIT_ID_SEQ", allocationSize = 1)
