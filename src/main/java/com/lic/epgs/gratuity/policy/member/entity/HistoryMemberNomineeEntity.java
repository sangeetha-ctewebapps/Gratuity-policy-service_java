...
@Entity
@Builder
@Table(name = "PMST_HIS_MEMBER_NOMINEE")
public class HistoryMemberNomineeEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_MBR_NOMINEE_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_MBR_NOMINEE_ID_SEQ", sequenceName = "PMST_HIS_MBR_NOMINEE_ID_SEQ", allocationSize = 1)
	...
	@Column(name = "PMST_MEMBER_NOMINEE_ID")
	private Long pmstMemNomineeId;
