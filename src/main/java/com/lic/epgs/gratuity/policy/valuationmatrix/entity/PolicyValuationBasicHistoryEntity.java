...
public class PolicyValuationBasicHistoryEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PMST_HIS_VAL_BASIC_ID_SEQ")
	@SequenceGenerator(name = "PMST_HIS_VAL_BASIC_ID_SEQ", sequenceName = "PMST_HIS_VAL_BASIC_ID_SEQ", allocationSize = 1)
