...
@Repository
public interface PolicyContrySummaryRepository extends JpaRepository<PolicyContrySummaryEntity, Long> {
	...
	List<PolicyContrySummaryEntity> deleteBytmpPolicyId(Long masterTmpPolicyId);
