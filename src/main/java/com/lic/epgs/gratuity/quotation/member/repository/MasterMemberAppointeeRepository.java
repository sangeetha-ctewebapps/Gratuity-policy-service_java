...
@Repository
public interface MasterMemberAppointeeRepository extends JpaRepository<MasterMemberAppointeeEntity, Long> {
	@Query(value = "UPDATE QMST_MEMBER_APPOINTEE m SET m.IS_ACTIVE=0 WHERE m.MEMBER_ID IN "
