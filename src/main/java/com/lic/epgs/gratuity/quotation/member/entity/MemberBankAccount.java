...
@Entity
@Builder
@Table(name = "QSTG_MEMBER_BANK_ACCOUNT")
public class MemberBankAccount {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QSTG_MEMBER_BANK_ACC_ID_SEQ")
	@SequenceGenerator(name = "QSTG_MEMBER_BANK_ACC_ID_SEQ", sequenceName = "QSTG_MEMBER_BANK_ACC_ID_SEQ", allocationSize = 1)
