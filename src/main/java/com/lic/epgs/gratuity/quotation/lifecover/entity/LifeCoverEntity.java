...
@Setter
@Entity
@Table(name = "QSTG_LIFE_COVER")
public class LifeCoverEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QSTG_LIFE_COVER_ID_SEQ")
	@SequenceGenerator(name = "QSTG_LIFE_COVER_ID_SEQ", sequenceName = "QSTG_LIFE_COVER_ID_SEQ", allocationSize = 1)
