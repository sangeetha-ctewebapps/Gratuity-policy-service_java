...
@Entity
@Builder
@Table(name = "QMST_MEMBER_NOMINEE")
public class MasterMemberNomineeEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QMST_MEMBER_NOMINEE_ID_SEQ")
	@SequenceGenerator(name = "QMST_MEMBER_NOMINEE_ID_SEQ", sequenceName = "QMST_MEMBER_NOMINEE_ID_SEQ", allocationSize = 1)
