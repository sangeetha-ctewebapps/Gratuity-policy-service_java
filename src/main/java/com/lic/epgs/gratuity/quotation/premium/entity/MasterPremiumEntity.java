...
@Setter
@Entity
@Table(name = "QMST_PREMIUM")
public class MasterPremiumEntity {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QMST_PREMIUM_ID_SEQ")
	@SequenceGenerator(name = "QMST_PREMIUM_ID_SEQ", sequenceName = "QMST_PREMIUM_ID_SEQ", allocationSize = 1)
