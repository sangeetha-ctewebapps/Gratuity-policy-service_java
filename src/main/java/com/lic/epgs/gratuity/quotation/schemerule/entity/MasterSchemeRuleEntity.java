...
@Setter
@Entity
@Table(name = "QMST_SCHEMERULE")
public class MasterSchemeRuleEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QMST_SCHEMERULE_ID_SEQ")
	@SequenceGenerator(name = "QMST_SCHEMERULE_ID_SEQ", sequenceName = "QMST_SCHEMERULE_ID_SEQ", allocationSize = 1)
