...
@Setter
@Entity
@Table(name = "QSTG_DOCUMENT")
public class DocumentEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QSTG_DOCUMENT_ID_SEQ")
	@SequenceGenerator(name = "QSTG_DOCUMENT_ID_SEQ", sequenceName = "QSTG_DOCUMENT_ID_SEQ", allocationSize = 1)
