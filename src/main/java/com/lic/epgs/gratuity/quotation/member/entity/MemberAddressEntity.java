...
@Entity
@Builder
@Table(name = "QSTG_MEMBER_ADDRESS")
public class MemberAddressEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "QSTG_MEMBER_ADDRESS_ID_SEQ")
	@SequenceGenerator(name = "QSTG_MEMBER_ADDRESS_ID_SEQ", sequenceName = "QSTG_MEMBER_ADDRESS_ID_SEQ", allocationSize = 1)
