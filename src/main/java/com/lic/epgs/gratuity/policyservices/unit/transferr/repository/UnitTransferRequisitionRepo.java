...
public interface UnitTransferRequisitionRepo extends JpaRepository<UnitTransferRequisitionEntity, Long> {
	...
	@Query(value = "SELECT UNIT_TRANSFER_REQUEST_NUMBER_SEQ.nextval S " + "  FROM dual", nativeQuery = true)
	Long generateSeq();
